---
title: "Lab 1: Chi-squared, t, and F distributions (solutions)"
...
You should definitely feel free to work through this with someone else and just submit one version of the lab.  In that case, just put both of your names at the top of the document.  
...
2. Get practice with the basic functions for working with random variables and creating plots using ggplot2.  Examples of this R functionality are on the first three pages of the "Common Probability Distributions" handout, also linked to on the Resources page of our Moodle page.
...
ggplot(data = sample_data, mapping = aes(x = F_var)) +
  geom_histogram(mapping = aes(y = ..density..), fill = "cornflowerblue") +
